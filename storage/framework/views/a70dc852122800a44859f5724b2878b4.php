...
<head>
    ...
    <title>Register Seller — <?php echo e(config('app.name', 'Campus Market')); ?></title>
        ...
        <div class="p-6 sm:p-8 rounded-2xl bg-white border border-red-100 shadow-xl shadow-red-100/50 backdrop-blur-sm">
            <form action="#" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <p class="text-red-900 text-sm !mt-6 text-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-red-600 hover:text-red-700 hover:underline ml-1 whitespace-nowrap font-semibold transition-colors">Login here</a>
                </p>
            </form>
        </div>
...
<?php /**PATH /Users/radityasaputra/pplWeb/resources/views/register.blade.php ENDPATH**/ ?>