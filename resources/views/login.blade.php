...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gradient-to-r from-red-600 via-white to-red-600 min-h-screen flex items-center justify-center p-6 relative">
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <form class="space-y-6">
              ...
              <p class="text-red-900 text-sm !mt-6 text-center">Don't have an account? <a href="{{ route('register') }}" class="text-red-600 hover:text-red-700 hover:underline ml-1 whitespace-nowrap font-semibold transition-colors">Register here</a></p>
            </form>
          </div>
